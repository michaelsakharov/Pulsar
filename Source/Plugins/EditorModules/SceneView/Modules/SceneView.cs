...
namespace Duality.Editor.Plugins.SceneView
{
	public partial class SceneView : DockContent, IHelpProvider, IToolTipProvider
	{
		...
		{
			var selNodes = this.GetSelNodesFlattened();
		...
		private void componentToolStripMenuItem_Click(object sender, EventArgs e)
		{
			...
			{
				this.AddComponentOfTypeHandler(compTypeSelector.TypeReference);
			}
		}
		private void newToolStripMenuItem_ItemClicked(object sender, EventArgs e)
		{
			...
			if (clickedType != null) this.AddComponentOfTypeHandler(clickedType);
		}
