...
{
    class SkeletonSerializer : Duality.Resources.IResourceSerializer<Skeleton>
    {
        static readonly char[] Magic = new char[] { 'S', 'K', 'E', 'L' };
        const int Version_1 = 0x0100;

        private readonly Duality.IO.FileSystem FileSystem;

        public bool SupportsStreaming => false;

        public SkeletonSerializer(Duality.IO.FileSystem fileSystem)
        {
