...
namespace Duality.Graphics.Resources
{
    ...
    /// 
    /// </summary>
    class ShaderSerializer : Duality.Resources.IResourceSerializer<ShaderProgram>
    {
		...
		public ShaderSerializer(Backend backend, Duality.IO.FileSystem fileSystem, ResourceManager resourceManager)
        {
		...
		{
			return new ShaderProgram(_backend);
		}
