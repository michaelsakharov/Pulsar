...
namespace Duality.Graphics
{
	public class Camera
	{
		...
		{
			Orientation *= Quaternion.CreateFromAxisAngle(Vector3.UnitY, amount);
		}

		public void Pitch(float amount)
		{
			Orientation *= Quaternion.CreateFromAxisAngle(Vector3.UnitX, amount);
		}

		public void Roll(float amount)
		{
			Orientation *= Quaternion.CreateFromAxisAngle(Vector3.UnitZ, amount);
		}
