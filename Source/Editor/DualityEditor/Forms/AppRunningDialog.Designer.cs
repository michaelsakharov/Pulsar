namespace Duality.Editor.Forms
{
	partial class AppRunningDialog
	{
		...
		private void InitializeComponent()
		{
            ...
            this.descLabel.Text = "A Pulsar application with access to project files is currently running. For stabi" +
    "lity reasons, you can\'t edit the project until the application has quit.";
            ...
            this.Text = "Pulsar Application running...";
